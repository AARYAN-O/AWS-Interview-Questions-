...
Limited DML support (no UPDATE/DELETE natively, except via CTAS/INSERT).CTAS stands for Create Table As Select (Table itself means that we are persisting the data) 
...
The concepts used in paritioning and bucketing is same in spark as well as in athena
...
The most important thing that I came to know today is that AWS Glue Catalog is a centralized metadata repository that can be used across all the AWS services.

## When should you use the compression techniques in Athena?

<img width="269" height="206" alt="image" src="https://github.com/user-attachments/assets/68335b9d-be69-4c88-a0ae-17e907093878" />
